...
- [Testudos](https://testudos.io/) - UI and integration test automation for Qt applications with Python extensibility, scenario recording, direct access to Qt object properties, and CLI execution. Supports custom embedded targets and generates traceable test reports suitable for regulated environments.
