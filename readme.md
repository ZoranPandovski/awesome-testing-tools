...
- [Ava](https://github.com/avajs/ava) - Test runner for Node.js with a concise API, detailed error output, embrace of new language features and process isolation that let you write tests more effectively. So you can ship more awesome code.
...
- [Katalon Studio](https://www.katalon.com/) - Powerful test automation solution for web application, mobile, and web services. Being built on top of the Selenium and Appium frameworks, Katalon Studio takes advantage of these solutions for integrated software automation.
...
- [PestPHP](https://pestphp.com/) - The elegant PHP testing framework. Pest is a testing framework with a focus on simplicity, meticulously designed to bring back the joy of testing in PHP.
...
- [Telerik](https://www.telerik.com/) - The complete test automation solution for GUI, Performance, Load and API testing.Test web, mobile and desktop applications.
...
- [Maestro](https://www.mobile.dev/) - Simplest and most effective mobile(Android/iOS) UI testing framework.
...
- [Kali Linux](https://www.kali.org/) - New generation of the industry-leading BackTrack Linux penetration testing and security auditing Linux distribution. Kali Linux is a complete re-build of BackTrack from the ground up, adhering completely to Debian development standards.
...
- [Wireshark](https://www.wireshark.org/) - World's foremost and widely-used network protocol analyzer. It lets you see what's happening on your network at a microscopic level.
...
- [Truffle Suites](https://trufflesuite.com/) - Comprehensive suite of tools for smart contract development.
