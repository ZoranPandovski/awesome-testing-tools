...
- [qmax-mcp](https://github.com/Quality-Max/qmax-mcp) - MCP server and CLI that gives coding agents independent QA evidence before declaring a web change done. Scans a URL for console errors, broken links, accessibility issues, Core Web Vitals, SEO, security headers, cookies/trackers, mixed content, and page weight; generates a deterministic Playwright repro from a finding and runs it behind a human-approval gate.
