...
- [Parsistent](https://parsistent.com/tools/request-tester) - Browser-based HTTP request tester. Sends requests through HTTP/SOCKS proxies, imports and exports cURL, and shows the full redirect chain. Names the anti-bot system (Cloudflare, DataDome, PerimeterX) when one answers instead of the target. No signup.
