...
| Vedika API | Vedic astrology API with free sandbox environment for API testing. Includes 108+ endpoints (horoscopes, kundali, panchang, numerology, AI chatbot), Postman collection, and SDKs. | https://vedika.io/ | Free/Paid |
