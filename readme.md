...
- [whatbroke](https://github.com/arthi-arumugam-git/whatbroke) - Open-source CLI that diffs an AI agent's behavior between two runs for regression testing: tool calls, args, cost, latency, and outcome flips, with flake detection for non-deterministic agents and exit codes for CI.
